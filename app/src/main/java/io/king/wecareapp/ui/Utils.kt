...
import io.king.wecareapp.ui.auth.LoginFragment

fun <A: Activity> Activity.starttNewActivity(activity : Class<A>){
...
fun Fragment.handleApiError(
    ...
    when{
        ...
        failure.errorCode == 401 ->{
            ...
            val error = failure.errorBody?.contentType().toString()
